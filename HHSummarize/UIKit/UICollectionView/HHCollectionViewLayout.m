...
@interface HHCollectionViewLayout ()
...
@implementation HHCollectionViewLayout
...
- (void)prepareLayout
{
    ...
    for (NSInteger idx = 0; idx < _itemCount; idx++)
    {
        ...
        if (self.delegate) {
            itemHeight = [self.delegate collectionView:self.collectionView layout:self heigthForItemAtIndexPath:indexPath];
        }
